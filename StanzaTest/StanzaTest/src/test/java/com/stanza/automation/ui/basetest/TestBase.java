package com.stanza.automation.ui.basetest;
...
import com.stanza.automation.ui.util.TestUtil;
import com.stanza.automation.ui.util.WebEventListener;
...
public class TestBase {
	...
	public TestBase(){
		try {
			prop = new Properties();
			FileInputStream ip = new FileInputStream(System.getProperty("user.dir")+ "/src/test/java/com/stanza"
